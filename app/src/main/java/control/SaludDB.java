...
public  class SaludDB {
    ...
    public static abstract class UsuarioDB implements BaseColumns{
        ...
        public static final String CREAR_TABLA = "CREATE TABLE usuario(nombreUsuario TEXT PRIMARY KEY ,nombre TEXT NOT NULL,apellido TEXT NOT NULL,fechaNacimiento TEXT NOT NULL,genero TEXT NOT NULL)";
